...
export const EN_CONTENT: PresentationContent = {
  ...
  toolsPrimer: {
    ...
    recommendation: {
      ...
      text: "You probably already use ChatGPT or Claude. Good. Next step: try a coding tool like Cursor — even if you don't code. They're powerful for any complex task.",
    },
  },
  examples: {
    title: 'Real Examples',
...
export const DE_CONTENT: PresentationContent = {
  ...
  toolsPrimer: {
    ...
    categories: [
      {
        category: 'LLM Apps',
        icon: '[◯]',
        description: 'Chat-Interfaces zu KI. Gut für Fragen, Schreiben, Brainstorming.',
        tools: [
      ...
      {
        category: 'Produktivitäts-Wrapper',
        icon: '[▶]',
        description: 'KI, die Aktionen ausführen kann: browsen, recherchieren, Aufgaben autonom erledigen.',
        tools: [
        ...
        canDo: ['Themen autonom recherchieren', 'Websites browsen', 'Mehrstufige Aufgaben erledigen', 'Im Hintergrund arbeiten'],
        cantDo: ['Code schreiben', 'Auf deine lokale Entwicklungsumgebung zugreifen'],
      },
      {
        category: 'Coding Tools',
        icon: '[<>]',
        description: 'KI für Softwareentwicklung. Aber sie sind auch großartig für Nicht-Coding-Arbeit.',
        tools: [
    ...
    recommendation: {
      title: 'Wo anfangen?',
      text: 'Du nutzt wahrscheinlich schon ChatGPT oder Claude. Gut. Nächster Schritt: Probier ein Coding-Tool wie Cursor — auch wenn du nicht programmierst. Sie sind mächtig für jede komplexe Aufgabe.',
    },
  },
  examples: {
    ...
    personal: [
      ...
      },
      {
        name: 'Obsidian Plugin',
        by: 'Max W.',
        description: 'Auto-Tagging-Zusammenfassung in <3 Stunden mit kostenlosen Modellen',
        stat: '<3h',
      },
      {
        name: 'CV-Screening Agents',
    ...
    steps: [
      {
        ...
        bad: '"Bau ein Auth-System"',
        good: '"Interview mich über den Bau eines Auth-Systems. Was sind die wichtigsten Schritte?"',
      },
      {
        number: 2,
        ...
        bad: '"Bau ein Auth-System"',
        good: '"Bau Email/Passwort-Auth mit unserem bestehenden User-Model, mit JWT-Tokens, Passwort-Reset und Rate-Limiting"',
      },
      {
        number: 3,
        ...
        bad: '"Bau ein Auth-System"',
        good: '"Bau ein Auth-System. Kein OAuth oder Email-Verifizierung — es ist nur ein MVP."',
      },
      {
        number: 4,
        title: 'Erkläre warum',
        description: 'Kontext zählt. "Läuft bei jedem API-Request" führt zu anderem Code als "einmalige Migration."',
        bad: '"Bau ein Auth-System"',
        good: '"Bau ein Auth-System. Das ist eine Demo, um Stakeholdern das Konzept zu zeigen."',
      },
      {
        number: 5,
        ...
        good: 'Neuer Chat, klarer Prompt, frischer Start',
      },
      {
        number: 6,
        ...
        bad: 'Bei dem bleiben, was du kennst',
        good: 'Probier diese Woche ein neues Tool',
      },
    ],
  },
  closing: {
